...
export const Header = () => {
  const { documentTitle, setDocumentTitle, handleDocumentDownload } =
    useEditorStore();
    ...
    <header className="w-full flex items-center justify-between px-6 py-4 shadow-md">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <button
          ...
          className="p-2 rounded-md text-xs bg-blue-400 text-white font-semibold border-none outline-0 px-4 flex items-center gap-x-1 cursor-pointer hover:bg-blue-500 transition-colors duration-200"
        >
          Download
